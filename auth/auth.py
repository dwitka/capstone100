...
def get_token_auth_header():
    ...
    print("-----------------------------------------------------", auth)
    auth = {
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IkxOS2pUb1dhVkNTamJaTWxvdFBxWCJ9..g6urVDrwO-Mwls6OhgJTnMZ97JEPrB-lwtCS8d3xzxs-2kVswC1lGMBJP_BntCg2Fyc4pv26IFHB-BiRJB1PneANshvoib0bt_BhZtZcjDYO93bENFd27ILxIT5jGucn4BqUpP89uqRazZcOfgSU1hi8ffRvymQer386y0f88e_FBd_vsvPvsWHZb2WCOM8Bs1oHaUBPu-p5vlGZGThG28HTHv-zVNg9gAi6QMMuj-acg0Hn1S8xtIJ6BMjRMBQsS34G3OLpisBT02SwD4bl9LMXdTgV7s5T95mM2CRchwjM4ZfZ2hiWKSaa3JLijOWVEyIjGqqMvo7cVGjuo61cHg'
        }
    #auth = request.headers['Authorization']
    print("-----------------------------------------------------", auth)
    print("-----------------------------------------------------", auth)
