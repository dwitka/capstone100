...
def get_token_auth_header():
    ...
    print("-----------------------------------------------------", auth)
    auth = {
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IkxOS2pUb1dhVkNTamJaTWxvdFBxWCJ9..KlSzWimqicavpA29bTyjzE9aLZ75h9pZ8w3EN-jlUH8SFtB3Tq4_RosYEF3ZJitacUUyzROL56KB0F9LVsPi1ZeOZv9mu4b4I9hyuIVQ6BKaVYKdy9DJplCWcumD3cXWjNhj9880exwleKFDxaQJg10LlwBve2Rzet58aprQ2pPucJ5nx-gXeSzyM94DmpjrOktVnsOOGUddKFurjuYyJ40wkL2SYWf0HT79JQCZSvZKWPva_nPUN_wpr0ryRxBl-97voVzg-ACGr_Kcx7lgRnEG6nodhr7cGb_za8xEoYwCoiDNVLAwzsAHvcbPUZPtmTnCzK2nTmszqkwljhmEqw'
        }
    #auth = request.headers['Authorization']
    print("-----------------------------------------------------", auth)
    print("-----------------------------------------------------", auth)
